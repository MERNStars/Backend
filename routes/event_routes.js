...
const {createEvent, index, update, publish, deleteEvent, findEventByKeywords, findEventById, findEventCategory, attendEvent, unattendEvent, getEventAttendees, getImageUrl, togglePublish} = require('../controllers/event_controllers');
