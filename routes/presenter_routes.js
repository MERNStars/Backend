...
const { index, createPresenter, updatePresenter, deletePresenter, findPresenterByName } = require("../controllers/presenter_controllers");
...
router.get('/:query', middleware.checkAdminToken, findPresenterByName);
